        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddAuthentication("Bearer")
                .AddJwtBearer("Bearer", options =>
                {
                    ...
                    {
                        ValidateIssuer = true, // נרצה לוודא שהטוקן הגיע מה-issuer שאנחנו מצפים לו
                        ValidIssuer = builder.Configuration["Authentication:Issuer"], // נוכל להגדיר את ה-issuer בקובץ appsettings.json או ב-User Secrets

                        ValidateAudience = true,
                        ValidAudience = builder.Configuration["Authentication:Audience"], // נוכל להגדיר את ה-audience בקובץ appsettings.json או ב-User Secrets
